...
public class LoginCardReader implements NfcAdapter.ReaderCallback {
    ...
    private WeakReference<LoginCallback> mAccountCallback;
    ...
    public LoginCardReader(LoginCallback accountCallback) {
        mAccountCallback = new WeakReference<LoginCallback>(accountCallback);
    }
        ...
        if (isoDep != null) {
            try {
                ...
                if (Arrays.equals(SELECT_OK_SW, statusWord)) {
                    ...
                    System.out.println("Received: " + accountNumber);
